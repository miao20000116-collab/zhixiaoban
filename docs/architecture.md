...
L4 专业 Agent 层  Resume / Job / Interview / Career / Gap / Recommendation / Evaluation
L5 AI 基础能力层  Memory / RAG(pgvector 预留) / LLM Provider
L6 数据与工具层   PostgreSQL / 搜索 / 文件解析 / ASR+TTS（已实现；非真流式）
```
